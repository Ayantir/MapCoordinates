...
function MapCoords:Initialize(parent)
	...
	self.coordsSearch = WINDOW_MANAGER:CreateControlFromVirtual("Search", self.control, "MapCoordinates_Research_Template")
...
function MapCoords:OnGamepadPreferredModeChanged()
...
local function OnAddonLoaded(event, addonName)
	...
	if addonName == ADDON_NAME then
		...
		ZO_CreateStringId("MAPCOORDS_SEARCH_PLACEHOLDER", "Coords:")
